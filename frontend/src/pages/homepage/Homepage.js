        ...
        <section id="homepage" style={{ backgroundColor: '#f8fafc'}}>
            ...
            <div style={{ 
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column'}}>
                    <div style={{ fontSize: '18px', lineHeight: '1.6', display: 'flex', flexDirection: 'column'}}>
                        ...
                        <p>I'm especially interested in modern web applications, backend development, and creating software that is both functional and allows great user experience. Outside of development, I'm always looking for opportunities to grow as a developer and take on new technical challenges.</p>
                    </div>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '350px' }}>
                    ...
                    <div style={{ 
                        ...
                        style={{ textDecoration: 'none', color: 'black', fontSize: '18px', display: 'flex', alignItems: 'center' }}>
                            LinkedIn <FaLinkedin style={{ marginLeft: '0.5rem', color: "#0077b5" }} />
                        </a>
